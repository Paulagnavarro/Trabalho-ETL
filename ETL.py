...
try:
    ...
    dados = pd.read_csv('C:/Users/Paula/Documents/microdados_censo_da_educacao_superior_2021/Microdados do Censo da Educação Superior 2021/dados/MICRODADOS_CADASTRO_CURSOS_2021.CSV'
                        ,sep=';'
                        , encoding='iso-8859-1'
                        , low_memory=False)
    dados = dados.fillna('')  
    ...
    #IES
    dados_IES = pd.read_csv('C:/Users/Paula/Documents/microdados_censo_da_educacao_superior_2021/Microdados do Censo da Educação Superior 2021/dados/MICRODADOS_CADASTRO_IES_2021.CSV'
                    ,sep=';'
                    , encoding='iso-8859-1'
                    , low_memory=False)
